    ...
    <section ref={sectionRef} className="bg-gradient-to-b from-[#EAEEFE] to-[#d78451] py-24 overflow-x-clip">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="section-heading">
          <div className="flex justify-center">
            <div className="tag flex items-center">
              {/* Flickering dot */}
              <motion.div 
                className="w-2 h-2 rounded-full bg-gradient-to-r from-[#ff734d] to-[#d64000] mr-2"
          ...
          <h2 className="text-center text-[34px] md:text-[54px] md:leading-[60px] font-bold tracking-tighter bg-gradient-to-b from-[#ff734d] to-[#d64000] text-transparent bg-clip-text mt-5">
            AI Meets Genomics: 
            <br />  
            Detect <span className="relative inline-block bg-gradient-to-b from-[#ff734d] to-[#d64000] text-transparent bg-clip-text">
              <span ref={geneticRisksRef}>Genetic Risks</span>
              <motion.span 
                className="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-[#000000] to-[#000000] rounded-full"
                initial="hidden"
                animate="visible"
                variants={underlineVariants}
              />
            </span> Before They Become Disease
          </h2>
          ...
          <div className="flex items-center justify-center gap-6 mt-5">
            ...
            <button className="btn btn-primary group relative overflow-hidden">
              <span className="inline-flex items-center">
                ...
                <svg 
                  ...
                  className="h-4 w-4 ml-1 transition-transform duration-300 ease-in-out group-hover:translate-x-1" 
                  fill="none" 
                  viewBox="0 0 24 24" 
                  stroke="currentColor"
                >
            ...
            <button className="btn btn-text group relative overflow-hidden">
              <span className="inline-flex items-center">
                Github
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
        ...
        <div className="relative mt-16">
          ...
          <motion.div 
            className="absolute top-6 left-1/2 transform -translate-x-1/2 w-4/5 h-6 bg-black rounded-full blur-md"
